...
def merge_sort(draw_info, ascending=True):
    ...
    if len(lst) > 1:
        ...
        left_gen = merge_sort_generator(draw_info, left_arr, ascending)
        right_gen = merge_sort_generator(draw_info, right_arr, ascending)
        ...
        while i < len(left_arr) and j < len(right_arr):
            ...
            k += 1
            draw_info.lst = lst
            drawn_list(draw_info, {k: draw_info.BLUE, j: draw_info.RED}, True)
            yield True
        ...
        while i < len(left_arr):
            ...
            k += 1
            draw_info.lst = lst
            drawn_list(draw_info, {k: draw_info.BLUE}, True)
            yield True
        ...
        while j < len(right_arr):
            ...
            k += 1
            draw_info.lst = lst
            drawn_list(draw_info, {k: draw_info.RED}, True)
            yield True

def merge_sort_generator(draw_info, lst, ascending):
    if len(lst) > 1:
        mid = len(lst) // 2
        left_arr = lst[:mid]
        right_arr = lst[mid:]
